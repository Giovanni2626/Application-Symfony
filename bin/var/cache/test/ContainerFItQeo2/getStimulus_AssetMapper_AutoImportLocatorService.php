...
class getStimulus_AssetMapper_AutoImportLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\UX\StimulusBundle\AssetMapper\AutoImportLocator(($container->privates['asset_mapper.importmap.config_reader'] ?? $container->load('getAssetMapper_Importmap_ConfigReaderService')), $a);

        if (isset($container->privates['stimulus.asset_mapper.auto_import_locator'])) {
            return $container->privates['stimulus.asset_mapper.auto_import_locator'];
        }

        return $container->privates['stimulus.asset_mapper.auto_import_locator'] = $instance;
    }
}
