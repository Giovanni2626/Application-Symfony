...
class getMailer_TransportFactoryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['mailer.transport_factory'])) {
            return $container->privates['mailer.transport_factory'];
        }

        return $container->privates['mailer.transport_factory'] = $instance;
    }
}
