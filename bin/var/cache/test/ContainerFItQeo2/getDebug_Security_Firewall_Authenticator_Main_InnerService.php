...
class getDebug_Security_Firewall_Authenticator_Main_InnerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener($a);

        if (isset($container->privates['debug.security.firewall.authenticator.main.inner'])) {
            return $container->privates['debug.security.firewall.authenticator.main.inner'];
        }

        return $container->privates['debug.security.firewall.authenticator.main.inner'] = $instance;
    }
}
