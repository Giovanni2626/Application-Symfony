...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 4), $a, ($container->privates['security.logout_listener.main'] ?? $container->load('getSecurity_LogoutListener_MainService')), ($container->privates['security.firewall.map.config.main'] ?? $container->load('getSecurity_Firewall_Map_Config_MainService')), ($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()));
